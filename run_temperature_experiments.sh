...
echo "Metrics: Survival Rate, Lifespan, Gini, Wealth, Suboptimal Moves"
echo ""
...
echo "========================================"
echo ""
MODEL_SUFFIX=$(echo "$MODEL" | tr '-' '_' | tr '.' '_')

echo "Results directories:"
echo "  - results_multiseed_${MODEL_SUFFIX}_temp0_0/"
echo "  - results_multiseed_${MODEL_SUFFIX}_temp0_3/"
echo "  - results_multiseed_${MODEL_SUFFIX}_temp0_7/"
echo ""
echo "To compare results across temperatures:"
echo "  ./compare_temperature_results.sh"
echo ""

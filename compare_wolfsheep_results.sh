...
OUTPUT_FILE="wolfsheep_comparison_${MODEL_SUFFIX}.txt"

{
echo "========================================="
echo "Wolf-Sheep Temperature Comparison Analysis"
echo "========================================="
echo ""
echo "Model: $MODEL"
echo ""
...
for i in "${!TEMPS[@]}"; do
  temp="${TEMPS[$i]}"
  label="${TEMP_LABELS[$i]}"
  dir="results_wolfsheep_${MODEL_SUFFIX}_temp${temp}"
...
print_table "Final Wolves" "Wolves" ""
print_table "Final Sheep" "Sheep" ""
print_table "Total Population" "Total Pop" ""
print_table "Peak Wolves" "Peak W" ""
print_table "Peak Sheep" "Peak S" ""
